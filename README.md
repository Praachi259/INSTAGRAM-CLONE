...
Ans 1: [<img src="images/question 2 answer.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;  

Ans 2:  [<img src="images/question 2 sec answer.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;    

3. We want to target our inactive users with an email campaign. Find the users who have never posted a photo
   
    [<img src="images/question 3 answer.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;  

4. We're running a new contest to see who can get the most likes on a single photo. WHO WON??

    [<img src="images/question 4 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;  
  
5. Our Investors want to know... ,How many times does the average user post?

    [<img src="images/question 5 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp; 
  
6. User ranking by postings higher to lower
   
    [<img src="images/question 6 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;  

7. Total Posts by users (longer versionof SELECT COUNT(*)FROM photos)

    [<img src="images/question 7 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;  

8. Total numbers of users who have posted at least one time

    [<img src="images/question 8 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;   

9. A brand wants to know which hashtags to use in a post ,What are the top 5 most commonly used hashtags?
 
    [<img src="images/question 9 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;   

10. We have a small problem with bots on our site... Find users who have liked every single photo on the site

    [<img src="images/question 10 ans.png" alt="insta-logo" width="400"/>](https://www.mysql.com/) &nbsp;   
